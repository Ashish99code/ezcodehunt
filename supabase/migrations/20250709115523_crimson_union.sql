/*
  # EZCode Initial Data Setup

  1. Categories
    - Insert 8 main tool categories with proper slugs and descriptions
  
  2. Sample Tools
    - GitHub Copilot (AI Assistant, Paid)
    - Cursor IDE (Code Editor, Freemium) 
    - Tabnine (AI Assistant, Freemium)
    - Replit (Browser IDE, Freemium)
    - CodeT5 (Code Generator, Free)
  
  3. Tool Features
    - Add relevant features for each tool with descriptions
  
  4. Tool Screenshots
    - Sample screenshots for each tool
...
((SELECT id FROM tools WHERE slug = 'tabnine'), 'Team Learning', 'Learns from your team code patterns', 'ai'),
